...
.choice-item.\!selected {
  --tw-border-opacity: 1;
  border-color: rgb(17 235 242 / var(--tw-border-opacity, 1));
  --tw-bg-opacity: 1;
  background-color: rgb(17 235 242 / var(--tw-bg-opacity, 1));
  font-weight: 600;
  --tw-text-opacity: 1;
...
.form-select:focus {
  ...
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(17 235 242 / var(--tw-ring-opacity, 1));
}
.form-select.err {
  --tw-border-opacity: 1;
  border-color: rgb(248 113 113 / var(--tw-border-opacity, 1));
...
.bg-\[\#11EBF2\]\/5 {
  background-color: rgb(17 235 242 / 0.05);
}
.bg-amber-100 {
  --tw-bg-opacity: 1;
